...
3. Haz clic en el botón verde de **Ejecutar (Run / Play) Que se encuentra hasta arriba o bien dentro del archivo Main.kt en la linea 67 alado debería salir un boton verde de Run** ubicado a la izquierda de la línea `fun main()`.
